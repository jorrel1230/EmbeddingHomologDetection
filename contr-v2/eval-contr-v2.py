...
if __name__ == "__main__":
    ...
    # Train set
    train_index = faiss.read_index('/scratch/gpfs/jr8867/main/contr-v2/embeddings/train_projected_embeddings.index')
    train_embeddings = np.load('/scratch/gpfs/jr8867/main/contr-v2/embeddings/train_projected_embeddings.npy')
    ...
    save_results(train_scores, train_labels, '/scratch/gpfs/jr8867/main/contr-v2/evals', 'train')

    del train_index, train_embeddings, train_indices, train_superfamilies, train_families
    gc.collect()
    
    # Test set
    test_index = faiss.read_index('/scratch/gpfs/jr8867/main/contr-v2/embeddings/test_projected_embeddings.index')
    test_embeddings = np.load('/scratch/gpfs/jr8867/main/contr-v2/embeddings/test_projected_embeddings.npy')
    ...
    save_results(test_scores, test_labels, '/scratch/gpfs/jr8867/main/contr-v2/evals', 'test')
