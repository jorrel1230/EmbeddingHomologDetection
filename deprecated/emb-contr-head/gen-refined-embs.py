...
np.save("/scratch/gpfs/jr8867/embeddings/scop/refined_embeddings_old.npy", refined_embeddings)
...
faiss.write_index(index, "/scratch/gpfs/jr8867/embeddings/scop/protein_embeddings_refined_old.index")
