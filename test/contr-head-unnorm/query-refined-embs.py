...
projection_model.load_state_dict(torch.load("/scratch/gpfs/jr8867/models/projection_model_200k_best.pth", map_location=device))
...
def search_similar_proteins(query_seq, index, metadata, k=5):
    ...
    # Sort by distance
    similar_proteins = similar_proteins.sort_values('distance', ascending=True)
...
if __name__ == "__main__":
    ...
    for i in range(5, 10):
        ...
        similar = search_similar_proteins(example_seq, index, scop_df, k=10)
