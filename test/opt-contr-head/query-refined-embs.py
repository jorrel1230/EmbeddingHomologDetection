...
projection_model.load_state_dict(torch.load("/scratch/gpfs/jr8867/models/projection_model_mining.pth", map_location=device))
...
if __name__ == "__main__":
    ...
    index = faiss.read_index('/scratch/gpfs/jr8867/embeddings/scop/train-test-split/train_embeddings_proj_L2.index')
