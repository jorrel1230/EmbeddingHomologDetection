...
projection_model.load_state_dict(torch.load("/scratch/gpfs/jr8867/main/contr-v3-Npair/models/contr-v3-small-npair.pth"))
...
np.save("/scratch/gpfs/jr8867/main/contr-v3-Npair/embeddings/train_projected_embeddings.npy", train_projected_embeddings)
np.save("/scratch/gpfs/jr8867/main/contr-v3-Npair/embeddings/test_projected_embeddings.npy", test_projected_embeddings)

# FAISS Indexing
train_index = faiss.IndexFlatL2(train_projected_embeddings.shape[1])
train_index.add(train_projected_embeddings)
faiss.write_index(train_index, "/scratch/gpfs/jr8867/main/contr-v3-Npair/embeddings/train_projected_embeddings.index")

test_index = faiss.IndexFlatL2(test_projected_embeddings.shape[1])
test_index.add(test_projected_embeddings)
faiss.write_index(test_index, "/scratch/gpfs/jr8867/main/contr-v3-Npair/embeddings/test_projected_embeddings.index")
